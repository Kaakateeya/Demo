            ...
            link: function(scope, element, attrs) {
                ...
                ! function($) {
                    ...
                    BootstrapTable.prototype.initToolbar = function() {
                        ...
                        html = [sprintf('<div id="bootstraptableshowoptions" class="columns columns-%s btn-group pull-%s bootstro">',
                        ...
                        if (this.options.search) {
                            html = [];
                            html.push(
                                '<div id="Bootstraptablesearch" class="pull-' + this.options.searchAlign + ' search bootstro">',
                        ...
                        if (!this.options.onlyInfoPagination) {
                            ...
                            $.each(pageList, function(i, page) {
                                if (!that.options.smartDisplay || i === 0 || pageList[i - 1] <= that.options.totalRows) {
                                    ...
                                    pageNumber.push(sprintf('<li%s><a href="javascript:void(0)" class="Droppage">%s</a></li>', active, page));
                                }
                            });
                ...
                // $('#ftable .page-next').click(function() {
                //     debugger;
                //     scope.$emit('loadmore');
                // });
